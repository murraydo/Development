...
public class VertragsService {
    ...
    /**
     * Vertrag anlegen oder Abgleich der Personendaten mit einem bestehenden
     * Vertrag 1. Prüfen, ist Vertrag existent (abgleich mit bestehenden
     * Versicherungsnummern bzw abgleich mit einem Haswert) 2. vertrag neu
     * anlegen
     *
     * @param person
     * @param vertrag

package com.mycompany.mavenproject1.client.samples;
...
import com.mycompany.mavenproject1.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.mycompany.mavenproject1.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
